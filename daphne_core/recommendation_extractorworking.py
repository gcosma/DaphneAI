"""
Strict Recommendation Extractor v2.5
Based on v2.4 with added HSIB format support.

v2.5 Changes:
- Added HSIB 2018 format: "Recommendation 2018/006:"
- Added HSIB 2023+ format: "Safety recommendation R/2023/220:"
- Added None checks to prevent 'NoneType' errors
- Fixed page number regex to not strip HSIB recommendation numbers
...
class StrictRecommendationExtractor:
    ...
    def is_genuine_recommendation(self, text: str, is_numbered_rec: bool = False) -> Tuple[bool, float, str, str]:
        ...
        # NEW: HSIB 2018 format (e.g., "Recommendation 2018/006:")
